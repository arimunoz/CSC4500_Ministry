...
class CampMembersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create camp_member" do
    assert_difference('CampMember.count') do
      post camp_members_url, params: { camp_member: { city: @camp_member.city, first_name: @camp_member.first_name, last_name: @camp_member.last_name, state: @camp_member.state, street: @camp_member.street, zip: @camp_member.zip } }
    end
  ...
  test "should update camp_member" do
    patch camp_member_url(@camp_member), params: { camp_member: { city: @camp_member.city, first_name: @camp_member.first_name, last_name: @camp_member.last_name, state: @camp_member.state, street: @camp_member.street, zip: @camp_member.zip } }
