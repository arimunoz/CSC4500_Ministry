...
class ChurchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create church" do
    assert_difference('Church.count') do
      post churches_url, params: { church: { church_name: @church.church_name, mens_leader: @church.mens_leader, pastor_name: @church.pastor_name } }
    end
  ...
  test "should update church" do
    patch church_url(@church), params: { church: { church_name: @church.church_name, mens_leader: @church.mens_leader, pastor_name: @church.pastor_name } }
