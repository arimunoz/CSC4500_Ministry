...
class EmergencyContactsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create emergency_contact" do
    assert_difference('EmergencyContact.count') do
      post emergency_contacts_url, params: { emergency_contact: { camp_member_id: @emergency_contact.camp_member_id, first_name: @emergency_contact.first_name, last_name: @emergency_contact.last_name, phone_number: @emergency_contact.phone_number, relationship: @emergency_contact.relationship } }
    end
  ...
  test "should update emergency_contact" do
    patch emergency_contact_url(@emergency_contact), params: { emergency_contact: { camp_member_id: @emergency_contact.camp_member_id, first_name: @emergency_contact.first_name, last_name: @emergency_contact.last_name, phone_number: @emergency_contact.phone_number, relationship: @emergency_contact.relationship } }
